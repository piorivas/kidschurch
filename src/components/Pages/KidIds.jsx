...
export const KidIds = () => {
    const { generateIds, getPdfUrl } = useIdCards();
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="p-2 pt-5 gap-2 flex items-center justify-center w-full md:w-auto">
                <iframe 
                    id="slides-iframe"
                    src="https://docs.google.com/presentation/d/e/2PACX-1vSJkEcTSnV9pm_PGpQqs4SWvCYZ6wadnWnC7P7-eeEb0H83JyVy72OH0HnD54SXtN5oIUpFRoCHkwMQ/embed?start=false&loop=false&delayms=60000" 
